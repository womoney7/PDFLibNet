...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ConvertPDF2Image("C:\\Users\\dengli\\Desktop\\New Microsoft Word Document.pdf", "C:\\Users\\dengli\\", "test", 1, 2);
        }
        ...
        public static void ConvertPDF2Image(string pdfInputPath, string imageOutputPath,
            string imageName, int startPageNum, int endPageNum, ImageFormat imageFormat = null)
        {
